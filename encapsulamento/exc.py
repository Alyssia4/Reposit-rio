...
class Triangulo:
    def __init__(self):
        ...
        self.h = 0
    def set_b(self, v):
        if v < 0 or v == 0: raise ValueError("a base não pode ser 0 e não pode ser negativo")
        self.b = v
    def get_b(self):
        return self.b
    def set_h(self, v):
        if v < 0 or v == 0: raise ValueError("a altura não pode ser 0 e não pode ser negativo")
        self.h = v
    def get_h(self):
        return self.h
    def calc_area(self):
